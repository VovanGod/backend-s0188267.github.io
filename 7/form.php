    ...
    <form action="index.php" method="POST">
        ...
        <div class="form-group">
            ...
            <?php if (!empty($messages['full_name'])): ?>
                <div class="error-message"><?php echo htmlspecialchars($messages['full_name']); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php if (!empty($messages['phone'])): ?>
                <div class="error-message"><?php echo htmlspecialchars($messages['phone']); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php if (!empty($messages['email'])): ?>
                <div class="error-message"><?php echo htmlspecialchars($messages['email']); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php if (!empty($messages['birth_date'])): ?>
                <div class="error-message"><?php echo htmlspecialchars($messages['birth_date']); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php if (!empty($messages['gender'])): ?>
                <div class="error-message"><?php echo htmlspecialchars($messages['gender']); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php if (!empty($messages['languages'])): ?>
                <div class="error-message"><?php echo htmlspecialchars($messages['languages']); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php if (!empty($messages['biography'])): ?>
                <div class="error-message"><?php echo htmlspecialchars($messages['biography']); ?></div>
            <?php endif; ?>
        </div>
        ...
        <div class="form-group agreement-field">
            ...
            <?php if (!empty($messages['agreement'])): ?>
                <div class="error-message"><?php echo htmlspecialchars($messages['agreement']); ?></div>
            <?php endif; ?>
        </div>
